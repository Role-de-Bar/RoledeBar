                ...
                <article className="artigo_form">
                    ...
                    <form className="form_login" onSubmit={login}>
                        ...
                        <div className="div-email">
                            <LabelTexto for="email" textoLabel="E-mail:" /><br />

                            <div>
                                <Mail className="iconeInput" size={20} />
                                <InputTexto type="email" id="email" placeholder="@example.com" name="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
                            </div>
                        </div>
                        <div className="div-senha">
                            ...
                            <div>
                                ...
                                <InputTexto type="password" id="senha" name="senha" placeholder="Minimo de 8 caracteres" value={senha} onChange={(e) => setSenha(e.target.value)} required />
                            </div>
                        </div>
                    ...
                    <div className="links_cadastro_recuperacao">
                        <div id="recuperar_senha">
                            <a href="#" onClick={handleOpen}>Esqueceu sua senha ?</a>
                        </div>
                        <div id="fazer_cadastro">
                            <a href="#" onClick={handleCadOpen}>Não tem uma conta ?</a>
                        </div>
                    </div>

                    <Dialog id="cadastre" open={cadDialog} onClose={handleCadClose}>
                        <DialogTitle className="titulo-escolha">Selecione o tipo de usuário:</DialogTitle>
                        <DialogContent className="tipo-usuario-container">
                            <div className="botoes-escolha">
                                <button
                                    className={`btn-tipo ${inputValue === "consumidor" ? "ativo" : ""}`}
                                ...
                                <button
                                    className={`btn-tipo ${inputValue === "proprietario" ? "ativo" : ""}`}
